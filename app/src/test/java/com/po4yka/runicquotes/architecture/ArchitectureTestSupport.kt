...
internal const val UI_SCREENS_PACKAGE = "com.po4yka.runicquotes.ui.screens.."
...
internal fun screenSourceFiles(): List<Path> {
    val screensRoot = resolveProductionSourcesRoot().resolve("com/po4yka/runicquotes/ui/screens")
